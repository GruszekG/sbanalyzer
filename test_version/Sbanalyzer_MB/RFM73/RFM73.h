...
//#define RFM73_IRQ  					GPIO_Pin_2    //SPI IRQ
#define RFM73_SS   					GPIO_Pin_3    //SPI SS
#define RFM73_SCK  					GPIO_Pin_5    //SPI SCK
#define RFM73_MISO 					GPIO_Pin_6    //SPI MISO
#define RFM73_MOSI 					GPIO_Pin_7    //SPI MOSI

#define RFM73_PWR   				GPIO_Pin_9    //SPI power PWR
#define RFM73_PWR_Port 				GPIOB     //RFM73 GPIO port for LEDS
#define RFM73_CE 					GPIO_Pin_8
//#define RFM73_LED_1 GPIO_Pin_0
//#define RFM73_LED_2 GPIO_Pin_1

//definicje do IRQ
#define RFM73_IRQ  					GPIO_Pin_2    //SPI IRQ
#define RFM73_IRQ_Src  				GPIO_PinSource2
#define RFM73_EXTI_Line  			EXTI_Line2
#define RFM73_IRQn					EXTI2_IRQn
