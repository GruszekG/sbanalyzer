...
**************************************************/
void CE_Low(void){	GPIO_ResetBits(RFM73_SPI_GPIO, RFM73_CE);}
void CE_High(void){	GPIO_SetBits(RFM73_SPI_GPIO, RFM73_CE);}
...
{ //GPIO and SPI configuration
  ...
  GPIO_InitStructure.GPIO_Pin = RFM73_SS | RFM73_CE | RFM73_PWR;      //SPI - SS, CE & PWR
...
//{
//	GPIO_ResetBits(RFM73_SPI_GPIO, RFM73_CE);
//}
//
//void RFM73_CE_High(void)
//{
//	GPIO_SetBits(RFM73_SPI_GPIO, RFM73_CE);
//}
...
{
	GPIO_SetBits(RFM73_SPI_GPIO, RFM73_PWR);
	//RFM73_SPI_GPIO->BSRR = RFM73_PWR;
}

void RFM73_PowerOFF(void)
{
	GPIO_ResetBits(RFM73_SPI_GPIO, RFM73_PWR);
...
{
	if(GPIO_ReadOutputDataBit(RFM73_LEDS, RFM73_LED_1)) GPIO_ResetBits(RFM73_LEDS, RFM73_LED_1);
	else GPIO_SetBits(RFM73_LEDS, RFM73_LED_1);	
}

void LED_2_Change(void)
{
	if(GPIO_ReadOutputDataBit(RFM73_LEDS, RFM73_LED_2)) GPIO_ResetBits(RFM73_LEDS, RFM73_LED_2);
	else GPIO_SetBits(RFM73_LEDS, RFM73_LED_2);	
}
